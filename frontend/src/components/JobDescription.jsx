    ...
    return (
        <div className='max-w-7xl mx-10 my-10'>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>{singleJob?.createdAt ? singleJob.createdAt.split("T")[0] : 'Not available'}</span></h1>
            </div>
        </div>
    )
}
